...
public class AdminRestControllerTest extends AbstractControllerTest {
    ...
    public void testUpdateArgumentNotValid() throws Exception {
        ...
        invalidUser.setCaloriesPerDay(0);
    ...
    public void testCreateArgumentNotValid() throws Exception{
        User invalidUser = new User(null, null, "newgmail.com", "newPass", 0, Role.ROLE_USER, Role.ROLE_ADMIN);
        ResultActions action = mockMvc.perform(post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .with(userHttpBasic(ADMIN))
                .content(UserTestData.jsonWithPassword(invalidUser, "newPass")))
                .andExpect(status().isConflict());
